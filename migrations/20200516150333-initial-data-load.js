  ...
  up: async (queryInterface) => {
    ...
    */
    ...
    return queryInterface.bulkInsert('novelsGenres', [
      { genreId: 1, novelId: 7 },
      { genreId: 2, novelId: 15 },
      { genreId: 3, novelId: 8 },
      { genreId: 4, novelId: 6 },
      { genreId: 5, novelId: 12 },
      { genreId: 5, novelId: 13 },
      { genreId: 6, novelId: 1 },
      { genreId: 6, novelId: 2 },
      { genreId: 7, novelId: 1 },
      { genreId: 7, novelId: 2 },
